...
export default function Hero() {
  ...
  return (
    <div className='py-4 md:py-10 flex flex-col gap-8 sm:gap-10'>
      ...
      <h1 className={'text-4xl sm:text-5xl md:text-6xl text-center ' + fugazOne.className}><span className='textGradient'>Broodl</span> helps you track your <span className='textGradient'>daily</span> mood!</h1>
